...
export function ThemeToggle() {
  ...
  if (!mounted) {
    return (
      <Button variant="ghost" size="icon" className="w-9 h-9 rounded-xl glass">
  ...
  return (
    <Button
      ...
      className="w-9 h-9 rounded-xl glass hover:bg-primary/10 transition-all duration-300 group"
      title="Toggle theme"
    >
